...
The **Book Manager API** is a simple RESTful application built with **FastAPI** that allows users to manage a collection of books. The project demonstrates client-server communication over HTTP by pairing a FastAPI backend with a custom Python Command Line Interface (CLI).
